...
{
    public partial class Word8Letters : UserControl
    {
        ...
        public Word8Letters()
        {
            ...
            tbArray = new System.Windows.Forms.TextBox[] { txtLetter1, txtLetter2, txtLetter3, txtLetter4, txtLetter5, txtLetter6, txtLetter7, txtLetter8 };
        ...
        public void HandleLetterFocus()
        {
            ...
            switch (letterCount)
            {
                ...
                case 6: txtLetter7.Focus(); break;
                default: txtLetter8.Focus(); break;
            }
        }
        ...
        private void HandleBackspace()
        {
            ...
            switch (letterCount)
            {
                ...
                case 6: txtLetter7.Text = ""; break;
                default: txtLetter8.Text = ""; break;
            }
        }

        private void UpdateCurrentWord()
        {
            _word = txtLetter1.Text + txtLetter2.Text + txtLetter3.Text + txtLetter4.Text + txtLetter5.Text + txtLetter6.Text + txtLetter7.Text + txtLetter8.Text;
        }
        ...
        private void txtLetter8_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtLetter8_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Back)
            {
                e.Handled = true;
            ...
            else if (e.KeyCode == Keys.Enter)
            {
                ...
                if (txtLetter8.Text.Length == 0) return;

                UpdateCurrentWord();
                OnWordEntered(EventArgs.Empty);
            }
            else if (txtLetter8.Text.Length > 0)
            {
                e.SuppressKeyPress = true;
            }
        }
